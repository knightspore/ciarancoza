...
function Homepage() {
    return (
        <div>
            <h1>
                <span className="text-xs font-medium">Hi, I'm<br /></span>
                <span className="text-2xl mt-2">Ciarán</span>
            </h1>
            <p className="mt-4">
                I'm a <Link href="/projects">software engineer</Link> / musician from Cape Town, South Africa. I have a keen interest in art and computers, history and people.
            </p>
            <p className="mt-4">
